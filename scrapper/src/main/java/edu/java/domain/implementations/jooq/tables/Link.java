...
public class Link extends TableImpl<LinkRecord> {
    ...
    public final TableField<LinkRecord, String> TYPE =
        createField(DSL.name("TYPE"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");

    /**
     * The column <code>LINK.DATA</code>.
     */
    public final TableField<LinkRecord, String> DATA =
        createField(DSL.name("DATA"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? super String, ? extends U> from
    ) {
